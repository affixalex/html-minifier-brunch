...
(function() {
  ...
  module.exports = HTMLMinifier = (function() {
    ...
    function HTMLMinifier(config) {
      var filter, optimize, fn, htmlminConfig, pluginConfig, _ref, _ref1, _ref2;
      ...
      this.destinationFn = pluginConfig.destinationFn != null ? pluginConfig.destinationFn : this.DEFAULT_DESTINATION_FN; 
